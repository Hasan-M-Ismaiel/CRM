<div aria-live="polite" aria-atomic="true" class="position-relative " >
    <div class="toast-container position-absolute top-0 end-0 p-3" >
        ...
        <a id="toast_link_to_task" href="" style="text-decoration: none;">
            <!--the toast-->
            ...
            <div class="toast-header">
                ...
                <!--from-->
                <!-- <span>I am </span> <strong id="toast_project_manager_name"></strong>
                <br> -->
                <!--grating-->
                <span>Hello {{Auth::user()->name}}</span> <strong class="me-auto" id="toast_title"> </strong>
                <!--the body-->
