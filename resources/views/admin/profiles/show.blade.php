                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="profile-work">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="{{ url($profile->facebook_account) }}">
                                ...
                                <div class="col">
                                    <a href="{{ url($profile->linkedin_account) }}">
                                ...
                                <div class="col">
                                    <a href="{{ url($profile->instagram_account) }}">
                                ...
                                <div class="col">
                                    <a href="{{ url($profile->twitter_account) }}">
                                ...
                                <div class="col">
                                    <a href="{{ url($profile->github_account) }}">
